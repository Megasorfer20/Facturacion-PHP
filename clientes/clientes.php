...
<head>
  ...
  <title>SUPERMARKET Clientes </title>
        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-danger" href="eliminarclientes.php?id=<?= $value ['cliente_id']?>&del=eliminar">Borrar</a>
                
                <a class="btn btn-warning" href="ediarclientes.php?id=<?= $value ['cliente_id']?>">Editar</a>
              </td>
            </tr>
                <?php  }?>
