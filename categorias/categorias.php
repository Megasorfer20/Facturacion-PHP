...
<head>
  ...
  <title>SUPERMARKET Categorias </title>
      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            ?>
            <tr>
              <td><?= $value ['categorias_id']?></td>
              <td><?= $value ['nombre']?></td>
              <td><?= $value ['descripcion']?></td>
              <td><img src="../images/Productos/<?= $value ['imagen']?>" alt="<?= $value ['imagen']?>" style="width: 120px;height: 120px;"></td>
              <td>
                <a class="btn btn-danger" href="eliminarCategorias.php?id=<?= $value ['categorias_id']?>&del=eliminar">Borrar</a>
                
                <a class="btn btn-warning" href="editarCategorias.php?id=<?= $value ['categorias_id']?>">Editar</a>
              </td>
            </tr>
                <?php  }?>
