        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td><?= $value ['imagen']?></td>
              <td>
                <a class="btn btn-danger" href="eliminarempleao.php?id=<?= $value ['empleado_id']?>&del=eliminar">Borrar</a>
                
                <a class="btn btn-warning" href="ediarempleao.php?id=<?= $value ['empleado_id']?>">Editar</a>
              </td>
            </tr>
                <?php  }?>
